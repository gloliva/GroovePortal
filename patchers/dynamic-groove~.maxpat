...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 125.0, 775.0, 44.0, 22.0 ],
					"text" : "sig~ 1.",
					"varname" : "g1-sig"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 134.5, 179.0, 102.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 50.0, 875.0, 119.0, 22.0 ],
					"text" : "*~ 1.",
					"varname" : "g1-amp"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 825.0, 69.0, 22.0 ],
					"text" : "groove~ b1",
					"varname" : "g1"
				}
